...
export class NonNegativeInteger extends Integer {
  ...
  static override fromNumber(value: number, options: ValidateOptions = {}): NonNegativeInteger {
    NonNegativeInteger.validate(value, options);
    return new NonNegativeInteger(value);
  }

  static override fromString(value: string, options: ValidateOptions = {}): NonNegativeInteger {
    return new NonNegativeInteger(NonNegativeInteger.validateString(value, options));
  }
}
